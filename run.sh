...
# 13g ->
python kaggle_ELL_train.py --total_max_len 1200 --batch_size 2 --epochs 5 --n_workers 8 --seed 43 --n_folds 5 # --model_name_or_path "hfl/chinese-macbert-large" # --train_path ./data/yb_train0.csv --val_path ./data/yb_test0.csv --seed 0  --fold 0  --model_name_or_path "hfl/chinese-roberta-wwm-ext-large"
